...
var actionUtil = {
    ...
    parseCriteria: function ( req ) {
        ...
        req.options.criteria.blacklist = req.options.criteria.blacklist || ['fields', 'limit', 'skip', 'sort', 'populate'];
    ...
    parseLimit: function (req) {
        var DEFAULT_LIMIT = req._sails.config.blueprints.defaultLimit || 500;
    ...
    checkFields: function (fields, model) {
        return _.difference(fields, _.keys(model.attributes));
    }
};
